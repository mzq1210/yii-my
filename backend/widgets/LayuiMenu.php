 ...
 * Theme menu widget.
 */
class LayuiMenu extends \yii\widgets\Menu
{
    /**
     * @inheritdoc
     */
    ...
    public $defaultIconHtmlIcon = '<i class="layui-icon layui-icon-home"></i> ';
    ...
    public static $iconClassPrefix = 'layui-icon layui-';
     ...
     */
    protected function renderItems($items, $status = false)
    {
        $n = count($items);
        $lines = [];
    ...
    {
        if (isset($item['url']) && is_array($item['url']) && isset($item['url'])) {
            $route = $item['url'];
